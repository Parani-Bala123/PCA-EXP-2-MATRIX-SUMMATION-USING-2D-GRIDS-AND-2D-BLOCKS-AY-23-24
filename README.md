...
## OUTPUT:
<img width="1009" height="195" alt="image" src="https://github.com/user-attachments/assets/80f24a82-8e07-4bcf-b4c2-9fb5c553820a" />


## RESULT:
The host took 1.04 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in ________ seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
